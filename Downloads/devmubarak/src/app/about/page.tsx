  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden transition-colors duration-300">
      ...
      <div className="pt-16 pb-16">
        {/* About Me Section */}
        <section className="py-20 px-4 sm:px-6 bg-black/50 backdrop-blur-sm relative">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Hi, I&apos;m <span className="bg-gradient-to-r from-black to-gray-400 bg-clip-text text-transparent">Mubarak</span>
              </h2>
            ...
            >
              <motion.div
                className="bg-black/70 backdrop-blur-sm rounded-xl p-6 border border-gray-800/50 text-center"
                whileHover={{ y: -5 }}
                transition={{ duration: 0.3 }}
              >
                <div className="w-12 h-12 bg-gradient-to-r from-black to-gray-700 rounded-xl flex items-center justify-center mx-auto mb-4">
              ...
              >
                ...
                <h3 className="text-lg font-bold text-white mb-2">Problem Solver</h3>
                <p className="text-gray-300 text-sm">
