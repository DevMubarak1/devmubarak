  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <motion.div
          className="text-2xl md:text-4xl font-semibold text-slate-600 dark:text-gray-300 mb-8"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Github className="w-6 h-6 text-slate-700 dark:text-gray-300 group-hover:text-blue-600 transition-colors duration-300" />
          </motion.a>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Linkedin className="w-6 h-6 text-slate-700 dark:text-gray-300 group-hover:text-blue-600 transition-colors duration-300" />
          </motion.a>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
          >
            <XIcon className="w-6 h-6 text-slate-700 dark:text-gray-300 group-hover:text-black dark:group-hover:text-white transition-colors duration-300" />
          </motion.a>
        </motion.div>
        ...
        >
          <motion.div
            className="w-6 h-10 border-2 border-slate-400 dark:border-gray-500 rounded-full flex justify-center"
            animate={{ y: [0, 10, 0] }}
            transition={{ duration: 2, repeat: Infinity }}
          >
            <motion.div
              className="w-1 h-3 bg-slate-400 dark:bg-gray-500 rounded-full mt-2"
              animate={{ y: [0, 12, 0] }}
              transition={{ duration: 2, repeat: Infinity }}
            />
          </motion.div>
