...
<<<<<<< HEAD
            ...
            <div className="text-center">
              <motion.div className="text-2xl md:text-3xl font-bold text-white mb-2" animate={{ y: [0, -6, 0] }} transition={{ duration: 2, repeat: Infinity, delay: 0.2 }}>
                3+
              </motion.div>
              <div className="text-gray-400 text-sm">Years Experience</div>
            </div>
            <div className="text-center">
              <motion.div className="text-2xl md:text-3xl font-bold text-white mb-2" animate={{ y: [0, -6, 0] }} transition={{ duration: 2, repeat: Infinity, delay: 0.4 }}>
                100%
              </motion.div>
