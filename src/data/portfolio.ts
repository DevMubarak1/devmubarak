...
export const workExperience = [
  {
    ...
    achievements: [
      ...
      "Integrated OpenAI API for intelligent cooking assistance",
      "Achieved 10,000+ active users within 6 months"
    ],
    tech: ["Next.js", "React Native", "OpenAI API", "Supabase", "TypeScript"],
    icon: "🚀"
  },
  {
    ...
    achievements: [
      ...
      "Implemented real-time order tracking and vendor management",
      "Integrated Flutterwave payment gateway with escrow system",
      "Reduced vendor onboarding time by 70%"
    ],
    tech: ["Next.js", "PostgreSQL", "Flutterwave", "Framer Motion", "Supabase"],
    icon: "🛍️"
  },
  {
    title: "Full-Stack Developer",
    ...
    achievements: [
      ...
      "Integrated Visa/Mastercard payment processing",
      "Implemented advanced product filtering and search",
      "Achieved 95% mobile responsiveness score"
    ],
    tech: ["Next.js", "React Carousel", "Supabase", "Auth.js", "TypeScript"],
    icon: "💄"
  },
  {
    ...
    achievements: [
      ...
      "Built Foodify Recipe Importer for seamless recipe saving",
      "Achieved 500+ active extension users",
      "Maintained 4.8+ star rating on Chrome Web Store"
    ],
    tech: ["JavaScript", "Chrome APIs", "JSON", "CSS", "HTML"],
    icon: "🔧"
  }
